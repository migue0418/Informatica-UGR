...
_pantalla::_pantalla()
{
	...
	pantalla.parametros(vertices,12,0);	

	pantalla.ambiente_difusa = _vertex4f(0.3, 0.4, 0.1, 1.0);
	pantalla.especular = _vertex4f(0.3, 0.45, 0.2, 1.0);
	brillo = 30;
	pantalla.calcular_normales_caras(1);
...
_pie::_pie()
{
	pieza_cil.ambiente_difusa = _vertex4f(r_r1, r_g1, r_b1, 1.0);
	pieza_cil.especular = _vertex4f(r_r1, r_g1, r_b1, 1.0);
	brillo = 30;
	pieza_cil.calcular_normales_caras(10);
};
...
void _pie::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	...
	pieza_cil.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(0.0,0.25,0);
	glScalef(0.45,1.0,0.45);
	pieza_cil.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
...
_lampara::_lampara()
{
	bombilla.ambiente_difusa = _vertex4f(0.8, 0.7, 0.4, 1.0);
	bombilla.especular = _vertex4f(0.4, 0.4, 0.4, 1.0);
	brillo = 30;
	bombilla.calcular_normales_caras(1);
};
...
void _lampara::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
	glPushMatrix();
		...
		glPushMatrix();
		pie.draw(modo, n_r1, n_g1, n_b1, n_r2, n_g2, n_b2, grosor);
		glPopMatrix();

		glPushMatrix();
		glTranslatef(0.0,1.45,0);
		glScalef(0.65,0.65,0.65);
		bombilla.draw(modo, w_r1, w_g1, w_b1, w_r2, w_g2, w_b2, grosor);
		glPopMatrix();

		glPushMatrix();
		glTranslatef(0.0,0.65,0);
		glScalef(0.7,1.1,0.7);
		pantalla.draw(modo, am_r1, am_g1, am_b1, am_r2, am_g2, am_b2, grosor);
		glPopMatrix();
	glPopMatrix();
};
