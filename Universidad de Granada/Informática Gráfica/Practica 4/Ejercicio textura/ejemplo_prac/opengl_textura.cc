...
float tam = 2.0, al = 3.0;

// OBJETO A DIBUJAR 1
GLfloat vertices[] = {-tam, 0, tam,    tam, 0, tam,   0, al, 0,
                      -tam, 0, -tam,  -tam, 0, tam,  0, al, 0,
                       tam, 0, -tam,  -tam, 0, -tam, 0, al, 0,
                       tam, 0, tam,    tam, 0, -tam,  0, al, 0};
...
// OBJETO A DIBUJAR 2
GLfloat vertices2[] = {-tam, -tam, tam,    tam, -tam, tam,    tam, tam, tam,    -tam, tam, tam,
