...
public:
   ...
   float _TARIFA1 = 12.97;		///< Tarifas
   float _TARIFA2 = 16.83;		///< Tarifas
   float _TARIFA3 = 29.32;		///< Tarifas
...
private:
   ...
   double _FACTORVOLUMETRICO = 6000.0;	 /// Empleado por la empresa de paquetería
